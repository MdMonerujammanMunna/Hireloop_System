...
import HeroSection from '../HeroBanner/HeroBanner';

export default function JobPortalHero() {
    return (
        <div className="min-h-70 py-20  relative overflow-hidden">
            <HeroSection />
            <div className="">
                {/* Background Image */}
                <div
                ...
                <div className="relative z-10 text-center">
                    ...
                    {/* Stats Grid */}
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap:2 mt-16 justify-items-center">
                        {/* Stat 1 */}
